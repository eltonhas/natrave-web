...
export const CardPalpite = ({ gameId ,homeTeam, awayTeam, homeTeamScore, awayTeamScore, disabled,gameTime}) => {
  ...
  return (
    <div className="rounded-xl border border-gray-300 p-4 text-center space-y-4">
      ...
      <span className="text-sm text-gray-700 font-bold md:text-base">{ gameTime }</span>
